...
>(
  (
    ...
    const contextValue = React.useMemo<SidebarContext>(
      ...
      [state, open, setOpen, isMobile, openMobile, setOpenMobile, toggleSidebar, isPinned]
    )
  ...
  (
    ...
    return (
      <div
        ref={ref}
        className={cn(
          "group fixed z-20 hidden h-svh text-sidebar-foreground transition-all duration-300 ease-in-out md:block",
          "w-[var(--sidebar-width)]",
...
>(
  (
    ...
    if (typeof tooltip === 'string') {
        tooltip = {
          children: <div className="group-data-[collapsible=icon]:hidden">{tooltip}</div>,
          content: tooltip
        }
    }


    const { content, ...tooltipProps } = typeof tooltip === 'object' ? tooltip : { content: tooltip };
