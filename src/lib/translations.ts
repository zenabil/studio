...
export const translations = {
  fr: {
    ...
    alerts: {
      ...
      smsBody: "Bonjour {customerName}, un rappel amical que votre paiement de {currency}{balance} est dû le {dueDate}. Merci de votre confiance.",
  ...
  ar: {
    ...
    alerts: {
      ...
      smsBody: "مرحباً {customerName}، نود تذكيركم بمودة بأن موعد استحقاق دفعتكم البالغة {currency}{balance} هو يوم {dueDate}. نشكركم على ثقتكم.",
