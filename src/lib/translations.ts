...
export const translations = {
  fr: {
    ...
    auth: {
      ...
      signupDescription: "Créez un compte pour commencer à utiliser le TPV.",
      signupButton: "Créer un compte",
      goToLogin: "Vous avez déjà un compte ?",
      ...
      subscriptionExpiredDescription: "Votre accès à l'application a expiré.",
      subscriptionExpiredContact: "Veuillez contacter l'administrateur pour renouveler votre abonnement.",
    },
    users: {
    ...
    profile: {
        ...
        subscriptionExpiresOn: "Votre abonnement expire le {date}.",
        daysRemaining: "{days} jours restants",
        noSubscription: "Pas de date d'expiration définie.",
        expired: "Expiré",
    ...
    customers: {
      ...
      viewInvoices: "Voir le relevé de compte",
      invoiceHistory: "Relevé de Compte",
      noInvoices: "Aucune transaction trouvée pour ce client.",
      ...
      emailExists: "Un client avec cet e-mail existe déjà.",
    ...
    alerts: {
      ...
      smsBody: "Bonjour {customerName}, un rappel amical que votre paiement de {currency}{balance} est dû le {dueDate}. Merci.",
    ...
    expenses: {
        ...
        noResultsFound: "Aucune dépense ne correspond à votre recherche.",
        ...
        deleteConfirmationTitle: "Confirmer la suppression",
        deleteConfirmationMessage: "Voulez-vous vraiment supprimer cette dépense ? Cette action est irréversible.",
        descriptionPlaceholder: "ex: Facture d'électricité",
        categoryPlaceholder: "ex: Services publics",
        amountPlaceholder: "0.00",
        categoryRequired: "La catégorie est obligatoire.",
        amountRequired: "Le montant est obligatoire et doit être supérieur à zéro.",
    ...
    zakat: {
        ...
        assets: "Actifs",
        assetsDescription: "Entrez les détails de vos actifs zakatables.",
        inventoryValue: "Valeur de l'inventaire (au prix d'achat)",
        accountsReceivable: "Créances clients",
        cash: "Liquidités (en main et en banque)",
        goldValue: "Valeur de l'or",
        silverValue: "Valeur de l'argent",
        totalAssets: "Total des Actifs",
        liabilities: "Passifs",
        liabilitiesDescription: "Entrez les dettes déductibles.",
        accountsPayable: "Dettes fournisseurs",
        otherDebts: "Autres dettes (prêts, etc.)",
        totalLiabilities: "Total des Passifs",
        calculation: "Calcul",
        goldPricePerGram: "Prix actuel de l'or par gramme",
        nisab: "Nisab (seuil)",
        zakatBase: "Base Zakat (Actifs - Passifs)",
        zakatDue: "Montant de la Zakat",
        nisabNotMet: "La base de Zakat est inférieure au Nisab. Aucune Zakat n'est due actuellement."
    },
    errors: {
      title: "Erreur",
  ...
  ar: {
    ...
    auth: {
      ...
      signupDescription: "أنشئ حسابًا لبدء استخدام نقطة البيع.",
      signupButton: "إنشاء حساب",
      goToLogin: "هل لديك حساب بالفعل؟",
      ...
      subscriptionExpiredDescription: "لقد انتهى وصولك إلى التطبيق.",
      subscriptionExpiredContact: "يرجى الاتصال بالمسؤول لتجديد اشتراكك.",
    },
    users: {
    ...
    profile: {
        ...
        subscriptionExpiresOn: "ينتهي اشتراكك في {date}.",
        daysRemaining: "يتبقى {days} يومًا",
        noSubscription: "لم يتم تحديد تاريخ انتهاء الصلاحية.",
        expired: "منتهي الصلاحية",
        yourProfile: "ملفك الشخصي",
        profileDescription: "حدّث معلوماتك الشخصية.",
        name: "الاسم",
        phone: "الهاتف",
    ...
    customers: {
      ...
      viewInvoices: "عرض كشف الحساب",
      invoiceHistory: "كشف حساب العميل",
      noInvoices: "لا توجد معاملات لهذا العميل.",
      ...
      emailExists: "يوجد عميل بهذا البريد الإلكتروني بالفعل.",
    ...
    alerts: {
      ...
      smsBody: "مرحباً {customerName}، نود تذكيركم بمودة بأن موعد استحقاق دفعتكم البالغة {currency}{balance} هو يوم {dueDate}. شكراً لثقتكم.",
    ...
    expenses: {
        ...
        noResultsFound: "لا توجد مصروفات تطابق بحثك.",
        expenseAdded: "تمت إضافة المصروف بنجاح.",
        expenseUpdated: "تم تحديث المصروف بنجاح.",
        expenseDeleted: "تم حذف المصروف بنجاح.",
        deleteConfirmationTitle: "تأكيد الحذف",
        deleteConfirmationMessage: "هل أنت متأكد من رغبتك في حذف هذا المصروف؟ هذا الإجراء لا يمكن التراجع عنه.",
        descriptionPlaceholder: "مثال: فاتورة الكهرباء",
        categoryPlaceholder: "مثال: فواتير خدمات",
        amountPlaceholder: "0.00",
        categoryRequired: "الفئة مطلوبة.",
        amountRequired: "المبلغ مطلوب ويجب أن يكون أكبر من صفر.",
        descriptionRequired: "الوصف مطلوب.",
        dateRequired: "التاريخ مطلوب.",
        totalExpenses: "إجمالي المصروفات للفترة",
    },
    zakat: {
        title: "حاسبة الزكاة",
        assets: "الأصول الزكوية",
        assetsDescription: "أدخل تفاصيل الأصول التي تجب فيها الزكاة.",
        inventoryValue: "قيمة المخزون (بسعر الشراء)",
        accountsReceivable: "الديون المستحقة لك (على العملاء)",
        cash: "السيولة النقدية (في الصندوق والبنك)",
        goldValue: "قيمة الذهب",
        silverValue: "قيمة الفضة",
        totalAssets: "مجموع الأصول",
        liabilities: "الخصوم",
        liabilitiesDescription: "أدخل الديون التي عليك والتي تستحق السداد.",
        accountsPayable: "الديون المستحقة للموردين",
        otherDebts: "ديون أخرى (قروض، إلخ)",
        totalLiabilities: "مجموع الخصوم",
        calculation: "الحساب",
        goldPricePerGram: "سعر غرام الذهب الحالي",
        nisab: "النصاب",
        zakatBase: "وعاء الزكاة (الأصول - الخصوم)",
        zakatDue: "مبلغ الزكاة المستحق",
        nisabNotMet: "وعاء الزكاة أقل من النصاب. لا تجب عليك الزكاة حاليًا."
    },
    errors: {
      title: "خطأ",
