...
export const translations = {
  fr: {
    ...
    settings: {
      ...
      enterActivationCode: "Saisissez votre code d'activation pour débloquer la version PRO.",
      activationCode: "Code d'activation",
      activate: "Activer",
      activationSuccess: "Activation réussie !",
      activationSuccessDesc: "Votre application est maintenant activée en version PRO.",
      activationError: "Code d'activation invalide.",
      licenseStatus: "Statut de la licence",
      proVersion: "Version PRO",
      trialVersion: "Version d'essai",
      licenseKeyManagement: "Gestion des clés de licence",
      generateNewKeys: "Générez et gérez les clés de licence pour votre application.",
    ...
    bakeryOrders: {
      ...
      deleteRecurringConfirmationMessage: "Vous êtes sur le point de supprimer une instance d'une commande récurrente. Êtes-vous sûr de vouloir continuer ?",
  ...
  ar: {
    ...
    settings: {
      ...
      enterActivationCode: "أدخل رمز التفعيل الخاص بك لفتح نسخة PRO.",
      activationCode: "رمز التفعيل",
      activate: "تفعيل",
      activationSuccess: "تم التفعيل بنجاح!",
      activationSuccessDesc: "تطبيقك مفعل الآن بنسخة PRO.",
      activationError: "رمز التفعيل غير صالح.",
      licenseStatus: "حالة الرخصة",
      proVersion: "نسخة PRO",
      trialVersion: "النسخة التجريبية",
      licenseKeyManagement: "إدارة مفاتيح الترخيص",
      generateNewKeys: "قم بإنشاء وإدارة مفاتيح الترخيص لتطبيقك.",
    ...
    bakeryOrders: {
      ...
      deleteRecurringConfirmationMessage: "أنت على وشك حذف نسخة من طلب متكرر. هل أنت متأكد من رغبتك في المتابعة؟",
