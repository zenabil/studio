...
*   **أوامر الشراء (`/purchase-orders`):**
    *   إنشاء وإدارة أوامر الشراء المرسلة للموردين.
    *   تتبع حالة كل طلب (مسودة، مرسل، مستلم جزئياً، مكتمل).
    *   تحويل أمر الشراء إلى فاتورة مورد بنقرة واحدة عند استلام البضاعة.
*   **فواتير الموردين:**
...
**ط. التنبيهات (`/alerts`)**
*   عرض قائمة بالمنتجات التي وصل مخزونها إلى الحد الأدنى، مع إمكانية إنشاء أمر شراء مباشرة.
*   عرض قائمة بالعملاء الذين لديهم فواتير مستحقة الدفع.

**ي. حاسبة الزكاة (`/zakat`)**
*   أداة متكاملة لحساب زكاة الأموال التجارية، تقوم تلقائيًا بجلب قيمة المخزون وديون العملاء والموردين.

**ك. الإعدادات (`/settings`)**
...
*   **الأمان:** يتم تأمين الوصول إلى البيانات من خلال قواعد أمان Firestore (`firestore.rules`)، والتي تضمن أن كل مستخدم يمكنه الوصول إلى بياناته الخاصة فقط.
...
*   **تطبيق ويب تقدمي (PWA):** التطبيق مصمم ليكون قابلاً للتثبيت على الأجهزة المكتبية والمحمولة للوصول السريع.
