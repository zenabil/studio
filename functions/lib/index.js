...
exports.updateUserProfile = exports.revokeUser = exports.approveUser = exports.createPendingUser = void 0;
...
exports.approveUser = (0, https_1.onCall)(async (request) => {
    ...
    if (!userIdToApprove) {
        throw new https_1.HttpsError("invalid-argument", "The function must be called with a 'userId' argument.");
    }
...
exports.revokeUser = (0, https_1.onCall)(async (request) => {
    var _a;
    if (!request.auth || !request.auth.token.email) {
        throw new https_1.HttpsError("unauthenticated", "The function must be called while authenticated.");
    }
...
exports.updateUserProfile = (0, https_1.onCall)(async (request) => {
    ...
    try {
        ...
        throw new https_1.HttpsError("internal", "An error occurred while updating the profile.");
    }
});
